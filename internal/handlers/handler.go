...
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "generals.page.html", &models.TemplateData{StringMap: stringMap})
}
...
func (m *Repository) Majors(w http.ResponseWriter, r *http.Request) {
	...
	stringMap["test"] = "Hello, again."
	render.Template(w, r, "majors.page.html", &models.TemplateData{StringMap: stringMap})
}
...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "make-reservation.page.html", &models.TemplateData{Form: forms.New(nil), Data: data, StringMap: stringMap})
}
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		...
		render.Template(w, r, "make-reservation.page.html", &models.TemplateData{Form: form, Data: data})
		return
	}
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	rooms, err := m.DB.SearchAvailabilityForAllRooms(startDate, endtDate)
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
...
func (m *Repository) Login(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "login.page.html", &models.TemplateData{Form: forms.New(nil)})
}
...
func (m *Repository) AdminNewReservations(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "admin-new-reservation.page.html", &models.TemplateData{Data: data})
}
...
func (m *Repository) AdminAllReservations(w http.ResponseWriter, r *http.Request) {
	...
	err = render.Template(w, r, "admin-all-reservation.page.html", &models.TemplateData{Data: data})
	log.Println(err)
}
...
func (m *Repository) AdminShowReservations(w http.ResponseWriter, r *http.Request) {
	...
	data := make(map[string]interface{})
	data["reservation"] = res
	render.Template(w, r, "admin-reservations-show.page.html", &models.TemplateData{Data: data, StringMap: stringMap, Form: forms.New((nil))})
}
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	currentLocation := now.Local().Location()
	...
	for _, x := range rooms {
		...
		for _, y := range restrictions {
			if y.ReservationID > 0 {
				// log.Println(y.StartDate.After(y.EndDate))
				for d := y.StartDate; !d.After(y.EndDate); d = d.AddDate(0, 0, 1) {
					// log.Println("ReservationID ", y.ReservationID)
					reservationMap[d.Format("2006-01-2")] = y.ReservationID
				}
			} else {
				// log.Println("RestrictionID ", y.RestrictionID)
	...
	render.Template(w, r, "admin-reservation-calendar.page.html", &models.TemplateData{StringMap: stringMap, Data: data, IntMap: intMap})
}
