...
--
-- Name: restrictions; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.restrictions OWNER TO root;

--
-- Name: restrictions_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.room_restrictions OWNER TO root;

--
-- Name: room_restrictions_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: restrictions id; Type: DEFAULT; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions id; Type: DEFAULT; Schema: public; Owner: root
--
...
--
-- Name: restrictions restrictions_pkey; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions room_restrictions_pkey; Type: CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: reservations_email_idx; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: reservations_last_name_idx; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions_reservation_id_idx; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions_room_id_idx; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions_start_date_end_date_idx; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: reservations reservations_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions room_restrictions_reservations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions room_restrictions_restrictions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: root
--
...
--
-- Name: room_restrictions room_restrictions_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: root
--
